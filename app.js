...
if (process.env.ENV === 'dev') {
    ...
    mongoose.connect(`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@storeclientapi.k61o6.mongodb.net/storeclientapi?retryWrites=true&w=majority`, { useNewUrlParser: true, user: process.env.DB_USER, pass: process.env.DB_PASS });
}
